...
import com.mbeliakov.snippeter.repository.AuthorityRepository;
...
public class UserService {
    ...
    public User registerUser(AdminUserModel userDTO, String password) {
        userRepository
    ...
    public User createUser(AdminUserModel userDTO) {
        User user = new User();
     ...
     * @return updated user.
     */
    public Optional<AdminUserModel> updateUser(AdminUserModel userDTO) {
        return Optional
    ...
    public Page<AdminUserModel> getAllManagedUsers(Pageable pageable) {
        return userRepository.findAll(pageable).map(AdminUserModel::new);
    }

    @Transactional(readOnly = true)
    public Page<UserModel> getAllPublicUsers(Pageable pageable) {
        return userRepository.findAllByIdNotNullAndActivatedIsTrue(pageable).map(UserModel::new);
    }
