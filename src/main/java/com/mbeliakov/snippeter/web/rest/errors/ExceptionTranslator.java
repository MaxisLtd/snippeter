package com.mbeliakov.snippeter.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, @Nonnull NativeWebRequest request) {
        ...
        List<FieldErrorVM> fieldErrors = result
            ...
            .map(
                f ->
                    new FieldErrorVM(
                        f.getObjectName().replaceFirst("Model$", ""),
                        f.getField(),
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.mbeliakov.snippeter.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        com.mbeliakov.snippeter.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.mbeliakov.snippeter.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.mbeliakov.snippeter");
    }
}
